    ...
    <body>
        ...
        <?php if ($type === 'attendance'): ?>
            <div class="report-info">
                ...
                <p><strong>Report Type:</strong> <?php echo ucfirst($params['report_type'] ?? 'All'); ?></p>
                <p><strong>Period:</strong> <?php echo $params['current_month'] ?? 'All Time'; ?></p>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo $record['session_name'] ? htmlspecialchars($record['session_name']) : 'Not Assigned'; ?></td>
                        <td><?php echo ucfirst($record['status']); ?></td>
                    </tr>
                    <?php endforeach; ?>
                </tbody>
...
try {
    ...
    $stmt = $conn->prepare("SELECT id, first_name, last_name FROM students WHERE status = 'active' ORDER BY first_name");
    $stmt->execute();
