    ...
    <div class="admin-container">
        ...
        <div class="main-content">
            <div class="dashboard-hero mb-4">
                <div class="hero-text">
                    <span class="eyebrow">Welcome back, <?php echo htmlspecialchars($_SESSION['first_name']); ?>!</span>
                    <h1>Let’s keep Gumamela Daycare running smoothly.</h1>
                    <p class="text-muted mb-0">Monitor enrollment, attendance, and parent engagement at a glance.</p>
                    <div class="hero-tags mt-3">
                        <span><i class="fas fa-child me-2"></i><?php echo $total_students; ?> Active Students</span>
                        <span><i class="fas fa-calendar-check me-2"></i><?php echo $attendance['present']; ?> Checked-in Today</span>
                        <span><i class="fas fa-envelope-open me-2"></i><?php echo $pending_parents; ?> Parent Approvals</span>
                    </div>
                </div>
                <div class="hero-panel">
                    <p class="mb-2 text-uppercase small text-muted">Enrollment Status</p>
                    <h3 class="mb-3 <?php echo $enrollment_enabled ? 'text-success' : 'text-warning'; ?>">
                        <?php echo $enrollment_enabled ? 'Open for Parents' : 'Temporarily Closed'; ?>
                    </h3>
                    <form method="POST">
                        ...
                        <button type="submit" class="btn btn-dark w-100">
                            ...
                            <?php echo $enrollment_enabled ? 'Pause Enrollment' : 'Resume Enrollment'; ?>
                        </button>
                    </form>
                </div>
            </div>
            ...
            <div class="system-banner mb-4 <?php echo $enrollment_enabled ? 'banner-success' : 'banner-warning'; ?>">
                <div class="banner-icon">
                    <i class="fas <?php echo $enrollment_enabled ? 'fa-door-open' : 'fa-door-closed'; ?>"></i>
                </div>
                <div>
                    <h5 class="mb-1">Parent Enrollment <?php echo $enrollment_enabled ? 'Enabled' : 'Disabled'; ?></h5>
                    <p class="mb-0">
                        <?php echo $enrollment_enabled
                            ? 'Parents may submit new applications through the portal.'
                            : 'Parents cannot enroll right now. Toggle the switch above to reopen.'; ?>
                    </p>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="metric-card">
                        ...
                        <div>
                            ...
                            <h2 class="metric-value"><?php echo $total_students; ?></h2>
                            <span class="metric-trend text-success"><i class="fas fa-arrow-up me-1"></i>Stable</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="metric-card">
                        ...
                        <div>
                            ...
                            <h2 class="metric-value"><?php echo $total_parents; ?></h2>
                            <span class="metric-trend text-success"><i class="fas fa-user-plus me-1"></i>Within capacity</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="metric-card">
                        ...
                        <div>
                            ...
                            <h2 class="metric-value"><?php echo $attendance['present']; ?></h2>
                            <span class="metric-trend text-info">Updated <?php echo date('g:i A'); ?></span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 mb-3">
                    <div class="metric-card">
                        ...
                        <div>
                            <p class="metric-label">Absent Today</p>
                            <h2 class="metric-value"><?php echo $attendance['absent']; ?></h2>
                            <span class="metric-trend text-danger">Needs follow-up</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-4 border-0 shadow-sm">
                <div class="card-header border-0 bg-transparent d-flex justify-content-between align-items-center">
                    ...
                    <small class="text-muted">Popular tasks curated for today</small>
                </div>
                <div class="card-body pt-0">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="attendance.php" class="action-tile">
                                <span class="tile-icon bg-primary-subtle text-primary"><i class="fas fa-calendar-check"></i></span>
                                <div>
                                    <h6>Attendance</h6>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="progress.php" class="action-tile">
                                <span class="tile-icon bg-success-subtle text-success"><i class="fas fa-chart-line"></i></span>
                                <div>
                                    <h6>Progress Report</h6>
                                    <p>Share child milestones</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="students.php?action=add" class="action-tile">
                                <span class="tile-icon bg-warning-subtle text-warning"><i class="fas fa-user-plus"></i></span>
                                <div>
                                    <h6>Register Child</h6>
                                    <p>Add new student record</p>
                                </div>
                            </a>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <a href="announcements.php?action=add" class="action-tile">
                                <span class="tile-icon bg-danger-subtle text-danger"><i class="fas fa-bullhorn"></i></span>
                                <div>
